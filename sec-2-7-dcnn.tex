...
\section{Deep convolutional neural networks}\label{sec:dcnn}
    ...
    instance recognition~\cite{razavian_cnn_2014,
      ...
      held_deep_2015,arandjelovic_netvlad_2015,arandjelovic_netvlad_2016,radenovic_cnn_2016}, %
    ...
    Data augmentation is used to artificially increase the amount of training data~\cite{ciresan_multicolumn_2012,
    ciresan_highperformance_2011, simard_best_2003}. The dropout technique has been shown to reducing
