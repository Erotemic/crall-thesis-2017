...
To allow the classifier to account for relationships between the unary attributes that could influence a pair of
  annotation's ability to match we encode distance measurements between the unary attributes.
...
Lastly, we include the ``speed'' of the annotations, which is the GPS-distance divided by the time-delta.
