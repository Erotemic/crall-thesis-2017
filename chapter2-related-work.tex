...
\chapter{Related work}\label{chap:relatedwork}
    ...
    %skinks, geckos, and
    %  salamanders~\cite{duyck_sloop_2015,martineztrinidad_relevance_2014}, %
    ...
    %---
    approximate nearest neighbor search~\cite{silpaanan_optimised_2008,
      muja_fast_2009},
    %---
    ...
    %---
    face verification~\cite{chopra_learning_2005,huang_labeled_2007,berg_tomvspete_2012,
    ...
    and convolutional neural networks~\cite{krizhevsky_imagenet_2012,
      razavian_cnn_2014, zagoruyko_learning_2015,han_matchnet_2015}.
    %---
