...
\newcommand{\SplitErrorsPZ}{
    ...
    % ---
    A reported split case from the plains zebras graph simulation.
...
\newcommand{\SplitErrorsGZ}{
    ...
    % ---
    A reported split case from the Grévy's zebras graph simulation.
    Further inspection shows that this split case is due to a \groundtruth{} error.
...
\newcommand{\MergeErrorPZA}{
    ...
    % ---
    A  merge case from the plains zebras graph simulation.
...
\newcommand{\MergeErrorGZA}{
    ...
    % ---
    A merge case from the Grévy's zebras graph simulation.
