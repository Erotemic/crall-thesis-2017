...
\chapter{Conclusion}\label{chap:conclusion} 
    ...
    \item {The ranking algorithm}:
        ...
        We have shown that tripling the number of annotations in a database can reduce the ranking accuracy at
          rank $1$ by $2\percent$.
        %The best choice for the $\K$ parameter (indicating the number of nearest descriptor neighbors) depends on
        %  the species and database size.
        %Overall, for highly distinctive species like Grévy's zebras, lower choices of $\K$ closer to $1$ seem
        %  better, and for less distinctive species like plains zebras, higher choices closer to $4$ seem to work
        %  best.
