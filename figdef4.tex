...
\newcommand{\ImportantPBFeat}{
    \begin{table}[h]
        ...
        Many of these features are related to the spatial location of the feature correspondences because
          photobombing animals tend to appear off to one side of an annotation.
        Other features like speed and GPS delta are important because photobombs are more common in pairs of
...
% ---
The MCC of photobomb-state classifier improves when using thresholds less than $0.5$.
...
% ---
In the top example the classifier incorrectly predicts photobomb due to the annotation's alignment.
...
%the animal in the left is also in the background of the right image, but the classifier
  %incorrectly predicts not photobomb because matches were not established between the two animals.
