...
\begin{figure}[h]
\centering
\begin{subfigure}[h]{0.47\textwidth}\centering\includegraphics[width=\textwidth]{figures4/PZ_Master1/score_hist_lnbnn.png}\caption{Plains zebra LNBNN}\label{sub:pos_lnbnn_hist_pz}\end{subfigure}
\begin{subfigure}[h]{0.47\textwidth}\centering\includegraphics[width=\textwidth]{figures4/PZ_Master1/score_hist_pos_learn(sum,glob).png}\caption{Plains zebra learned}\label{sub:pos_hist_pz}\end{subfigure}
\begin{subfigure}[h]{0.47\textwidth}\centering\includegraphics[width=\textwidth]{figures4/GZ_Master1/score_hist_lnbnn.png}\caption{Grévy's zebra LNBNN}\label{sub:pos_lnbnn_hist_gz}\end{subfigure}
\begin{subfigure}[h]{0.47\textwidth}\centering\includegraphics[width=\textwidth]{figures4/GZ_Master1/score_hist_pos_learn(sum,glob).png}\caption{Grévy's zebra learned}\label{sub:pos_hist_gz} \end{subfigure}
%~
...
\begin{table}[b]
    ...
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/PZ_Master1/confusion_match_state.tex}\caption{Plains zebra match-state confusion matrix}\end{subtable} %
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/GZ_Master1/confusion_match_state.tex}\caption{Grévy's zebra match-state confusion matrix}\end{subtable} %
\end{table}
}
...
\begin{table}[b]
    ...
    \centering
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/PZ_Master1/eval_metrics_match_state.tex}\caption{Plains zebra match-state metrics}\end{subtable} %
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/GZ_Master1/eval_metrics_match_state.tex}\caption{Grévy's zebra match-state metrics}\end{subtable} %
\end{table}
}
...
\begin{table}[h]
    ...
    \centering
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/PZ_Master1/eval_metrics_photobomb_state.tex}\caption{Plains zebra photobomb metrics} \end{subtable} %
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/GZ_Master1/eval_metrics_photobomb_state.tex}\caption{Grévy's zebra photobomb metrics}\end{subtable} %
\end{table}
}
...
\begin{table}[p]
    ...
    \centering
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/PZ_Master1/eval_metrics2_photobomb_state.tex}\caption{Plains zebra adjusted photobomb metrics} \end{subtable} %
    \begin{subtable}[h]{\textwidth}\centering\input{figures4/GZ_Master1/eval_metrics2_photobomb_state.tex}\caption{Grévy's zebra adjusted photobomb metrics}\end{subtable} %
\end{table}
}
