...
The incorrect pair of annotation \cref{sub:failqualityA} did not recieve a particularly high score, but it was
...
The annotations in the scenery match pair were taken seconds appart in the same location causing their
