...
% --- VIEWPOINT
\begin{comment}
python -m ibeis draw_match_cases --db GZ_Master1 --qaid 2787  -a timectrl -t best --filt :fail=True,sortdsc=gtscore --show --verbose
python -m ibeis draw_match_cases --db GZ_Master1 --qaid 2787  -a timectrl -t best --filt :fail=True,with_tag=Viewpoint,sortdsc=gtscore \
...
\begin{comment}
python -m ibeis draw_match_cases --db PZ_Master1 -a timectrl -t best --filt :fail=True,with_tag=Photobomb,sortdsc=gfscore  --show --verbose

python -m ibeis draw_match_cases --db PZ_Master1 -a timectrl -t best --filt :fail=True,with_tag=Photobomb,sortdsc=gfscore  \

python -m ibeis.dev -e draw_cases -a timectrl -t best --filt :fail=True,with_tag=Photobomb,sortdsc=gfscore  \
