...
\section{Instance recognition}\label{sec:ir}
    ...
    \subsection{Min hash}
        ...
        romberg_bundle_2013, chum_geometric_2009, chum_largescale_2010, chum_fast_2012, wang_semisupervised_2012}.
    ...
    \subsection{Fisher Vector}
        A Fisher Vector is an alternative to a bag-of-words~\cite{perronnin_largescale_2010-1,
        jegou_aggregating_2010}. Like bag-of-words, Fisher Vector representations have been used in both instance
        and category recognition~\cite{perronnin_fisher_2007, cinbis_image_2012, sun_largescale_2013,
        ...
        It is noted in~\cite{perronnin_largescale_2010-1} that using Fisher Vectors for instance recognition is
    ...
    \subsection{VLAD --- Vector of Locally Aggregated Descriptors} 
        ...
        introduced~\cite{arandjelovic_netvlad_2015,radenovic_cnn_2016}. NetVLAD uses deep learning with a triplet
    ...
    \subsection{Face recognition and verification}
        ...
        machines (SVMs)~\cite{phillips_support_1998, levy_svmminus_2013}.
        ...
        popular techniques to retrieve faces~\cite{aharon_ksvd_2006, wright_robust_2009, zhang_sparse_2011,
    ...
    \subsection{Discussion --- instance recognition}
        ...
        datasets with $10,000$ to $90,000$ images~\cite{arandjelovic_netvlad_2015}. We simply do not have this much
