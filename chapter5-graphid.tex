...
We initialize $\mu_0=1$ to denote that it is likely that the first review will be label-changing.
...
In this example we use a window span of $s=20$, a patience of $a=20$, and a threshold of $\tau=0.135$.
