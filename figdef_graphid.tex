...
% ---
The user simulation experiment comparing the three identification algorithms
...
The probability that the next reviews will be meaningful is high while new merges are discovered.
...
Identification converges in $3$ iterations for plains zebras and $4$ for Grevy's.
% ---
}
\label{fig:Refresh}
\end{figure}
