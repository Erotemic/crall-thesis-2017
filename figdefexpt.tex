...
python -m ibeis -e rank_cmc --db PZ_Master1   -a ctrl timectrl   -t baseline --prefix "Baseline" --label PZBaseline --cmap-hack=autumn \
    --clipwhite --save=pzcmc.jpg  \
    --dpi=128 --legendsize=11 --labelsize=14 --titlesize=12 --figtitlesize=12 --ticksize=10 --figsize=9,3 --draw-icon=True --overlay-zoom=.2
...
python -m ibeis -e rank_cmc --db GZ_Master1   -a ctrl timectrl   -t baseline --prefix "Baseline" --label GZBaseline --cmap-hack=autumn \
    --clipwhite --save=gzcmc.jpg \
    --dpi=128 --legendsize=11 --labelsize=14 --titlesize=12 --figtitlesize=12 --ticksize=10 --figsize=9,3 --draw-icon=True --overlay-zoom=.2


python -m ibeis -e rank_cmc --db PZ_MTEST   -a ctrl   -t baseline --prefix "MTEST" --label MTEST --cmap-hack=autumn \
    --dpi=128 --clipwhite --save=mtestcmc.jpg \
    --legendsize=12 --labelsize=12 --titlesize=10 --figtitlesize=10 --ticksize=10 --figsize=6,3 --draw-icon=True --overlay-zoom=.1
...
\MultiImageCommandII{BaselineExpt}{1}{Baseline experiment identification accuracy}{
    ...
    % ---
    Results for plains zebras are shown in~\cref{sub:BaselineExptA}, Grévy's
...
The effect of the foregroundness weight on identification accuracy}{
    ...
    Results for plains zebras are shown in~\cref{sub:ForegroundExptA},
      Grévy's zebras are shown in~\cref{sub:ForegroundExptB}, and Masai
...
Results of the same-viewpoint invariance experiment}{
    ...
    \Cref{sub:InvarExptB} illustrates that the most accurate feature
      invariance setting for Grévy's zebras is affine invariance without
...
Results of the different-viewpoint invariance experiment}{
    ...
    \Cref{sub:InvarViewExptB} illustrates that affine invariant keypoints provide
      the most accurate identifications of Grévy's zebras when viewpoint are
      different.
...
\MultiImageCommandII{NScoreExpt}{1}{
    ...
    \Cref{sub:NScoreExptB} shows the results for Grévy's zebras.
