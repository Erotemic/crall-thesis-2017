...
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a ctrl timectrl   -t baseline --prefix "Baseline" --label PZBaseline --cmap-hack=autumn    --hargv=expt
\end{comment}                                                                                                                                         
                                                                                                                                                      
\begin{comment}                                                                                                                                       
python -m ibeis -e rank_cdf --db GZ_Master1   -a ctrl timectrl   -t baseline --prefix "Baseline" --label GZBaseline --cmap-hack=autumn    --hargv=expt
\end{comment}                                                                                                                                         
                                                                                                                                                      
\begin{comment}                                                                                                                                       
python -m ibeis -e rank_cdf --db GIRM_Master1 -a ctrl timectrl1h -t baseline --prefix "Baseline" --label GIRMBaseline --cmap-hack=autumn  --hargv=expt
\end{comment}


\begin{comment}                                                                                                                                       
python -m ibeis -e rank_cdf --db GIRM_Master1 -a timectrl1h -t baseline --prefix "Baseline" --label GIRMBaseline --cmap-hack=autumn  --save "{label}.png"
python -m ibeis -e rank_cdf --db humpbacks_fb -a timectrl1h -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db Seals -a timectrl1h -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db snails_drop1 -a timectrl1h -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db LF_Bajo_bonito -a timectrl1h -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db GIRM_Master1 -a ctrl -t baseline --prefix "Baseline" --label GIRMBaseline --cmap-hack=autumn  --save "{label}.png"
python -m ibeis -e rank_cdf --db humpbacks_fb -a ctrl -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db Seals -a ctrl -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db snails_drop1 -a ctrl -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
python -m ibeis -e rank_cdf --db LF_Bajo_bonito -a ctrl -t baseline --prefix "Baseline" --label HBBaseline --cmap-hack=autumn --save "{label}.png"
\end{comment}
...
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a timectrl   -t baseline:fg_on=[True,False]  --hargv=expt --prefix "Foregroundness" --label PZForeground  --cmap-hack=spring
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl   -t baseline:fg_on=[True,False]  --hargv=expt --prefix "Foregroundness" --label GZForeground --cmap-hack=spring

python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl   -t baseline:fg_on=[True],fgw_thresh=[None,.8] --show
\end{comment}

%\begin{comment}
%python -m ibeis -e rank_cdf --db GIRM_Master1 -a timectrl1h -t baseline:fg_on=[True,False]  --hargv=expt --prefix "Foreground" --label GIRMForeground
%\end{comment}
...
%\begin{comment}
%python -m ibeis -e rank_cdf --db PZ_Master1   -a timectrl   -t featscoremetch  --hargv=expt --prefix "LNBNN" --label PZLNBNN
%\end{comment}

%\begin{comment}
%python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl   -t best:fg_on=[True,False]  --hargv=expt --prefix "Foreground" --label GZForeground
%\end{comment}

%\begin{comment}
%python -m ibeis -e rank_cdf --db GIRM_Master1 -a timectrl1h -t best:fg_on=[True,False]  --hargv=expt --prefix "Foreground" --label GIRMForeground
%\end{comment}
...
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a timectrl   -t invar  --hargv=expt --prefix "Invariance" --label PZInvar --cmap-hack=Set1
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl   -t invar  --hargv=expt --prefix "Invariance" --label GZInvar --cmap-hack=Set1
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GIRM_Master1 -a timectrl1h -t invar  --hargv=expt --prefix "Invariance" --label GIRMInvar --cmap-hack=Set1
\end{comment}
...
% --- Across Viewpoints
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a viewdiff   -t invar  --hargv=expt --prefix "Invariance+View"  --label PZInvarView  --cmap-hack=Set2
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GZ_Master1   -a viewdiff   -t invar  --hargv=expt --prefix "Invariance+View"  --label GZInvarView --cmap-hack=Set2
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GIRM_Master1 -a viewdiff   -t invar  --hargv=expt --prefix "Invariance+View"  --label GIRMInvarView --cmap-hack=Set2
\end{comment}
...
% --- Explicit K 
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a timectrl   -t CircQRH_K --hargv=expt --prefix "K " --label PZKTime  --cmap-hack=gnuplot
\end{comment}
\begin{comment}

python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl   -t Ell_K     --hargv=expt --prefix "K " --label GZKTime --cmap-hack=gnuplot
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GIRM_Master1 -a timectrl1h -t Ell_K     --hargv=expt --prefix "K " --label GIRMKTime --cmap-hack=gnuplot
\end{comment}
...
\begin{comment}
python -m ibeis -e rank_cdf --db PZ_Master1   -a varypername_td   -t CircQRH_ScoreMech:K=3   --hargv=mech --prefix "Score Method" --label PZNscore  --ncolor-hack=6 --cmap-hack=jet
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GZ_Master1   -a varypername_td   -t Ell_ScoreMech:K=1     --hargv=mech --prefix "Score Method" --label GZNscore --ncolor-hack=6 --cmap-hack=jet
\end{comment}

\begin{comment}
python -m ibeis -e rank_cdf --db GIRM_Master1 -a varypername_td1h:qmin_pername=3,dpername=[1,2] -t Ell_ScoreMech:K=2     --hargv=mech --prefix "Score Method" --label GIRMNscore --ncolor-hack=6 --cmap-hack=jet
\end{comment}
...
python -m ibeis -e rank_cdf --db GZ_Master1   -a timectrl -t best best:chip_sqrt_area=700 --filt : --show
\end{comment}
