...
\begin{table}
    ...
    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/PZ_PB_RF_TRAIN_2589/confusion_match_state.tex}
        \caption{Plains zebras match state confusion}
    \end{subtable} %

    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/GZ_Master1_20590/confusion_match_state.tex}
...
\begin{table}
    ...
    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/PZ_PB_RF_TRAIN_2589/eval_metrics_match_state.tex}
        \caption{Plains zebras match state metrics}
    \end{subtable} %

    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/GZ_Master1_20590/eval_metrics_match_state.tex}
...
\begin{table}
    ...
    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/PZ_PB_RF_TRAIN_2589/eval_metrics_photobomb_state.tex}
        \caption{Plains zebras photobomb metrics}
    \end{subtable} %

    \begin{subtable}[h]{\textwidth}
        \centering
        \input{figures_pairclf/GZ_Master1_20590/eval_metrics_photobomb_state.tex}
