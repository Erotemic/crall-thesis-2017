...
\section{Experiments}\label{sec:graphexpt}
    ...
    This ensures that we do not automatically classify categories (\eg{} incomparable) with little supporting data.
    ...
    A false positive rate of $0.0014$ results in a positive threshold of $0.97$, a negative threshold of $0.99$,
      and an incomparable threshold of $1.0$.
    %For the convergence criteria use a patience of $a=20$, a window span of $s=20$, and a termination threshold
    %  of $0.5$, which causes the criteria to trigger after at most $7$ consecutive non-meaningful reviews.
    For the convergence criteria use a patience of $a=20$, a window span of $s=20$, and a termination threshold
