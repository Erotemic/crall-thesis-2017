...
\section{Experiments}\label{sec:graphexpt}
    ...
    In this section we design an end-to-end experiment that simulates an identification event like the \GZC{}.
    
    to measure the impact of graph identification on the number of manual
