...
\caption[A scale space pyramid]{\caplbl{ScaleSpaceFigure}
% ---
A Gaussian pyramid is used as a scale space representation of an image.
A property of scale space is that doubling the scale is equivalent to
  downsampling the image by half.
...
\caption[Example of a SIFT descriptor]{\caplbl{vizfeatrow}
% ---
...
\caption[Before and after spatial verification]{\caplbl{figSVInlier}
% ---
