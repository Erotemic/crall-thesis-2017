...
Thus, the total length of the feature vector is the number of measurements times, the number of summary
  statistics, times the number of ways feature correspondences are established.
...
\section{Pairwise classification experiments}\label{sec:pairexpt}
    ...
    \subsection{Evaluating the match-state classifier}
        ...
        The MCC of $0.91$ for Grévy's zebras and $0.83$ for plains zebras, indicating that our classifiers have
